        ...
        if( cropf_col(c)  <  1.0 )then
           if (trotr1_col(c)+trotr2_col(c)>0.6_r8) then
              ...
              do j = 1, nlevdecomp 
                ...
                else if (spinup_state == 1 .and. kyr >= 40 .and. nu_com .eq. 'RD') then 
                  fuelc(c) = fuelc(c)+decomp_cpools_vr(c,j,i_cwd) *dzsoi_decomp(j) * &
           ...
           do l = 1, ndecomp_pools
              ...
              if ( is_cwd(l) ) then
                 ...
                 if (spinup_state == 1) then 
                   ...
                   if (kyr >= 40 .and. nu_com .eq. 'RD') m_decomp_cpools_to_fire_vr(c,j,l) = &
              ...
              if ( is_cwd(l) ) then
                 ...
                 if (spinup_state == 1) then 
                   m_decomp_npools_to_fire_vr(c,j,l) = m_decomp_npools_to_fire_vr(c,j,l) * &
                     decomp_cascade_con%spinup_factor(l) 
                   if (kyr >= 40 .and. nu_com .eq. 'RD') m_decomp_npools_to_fire_vr(c,j,l) = &
